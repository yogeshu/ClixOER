...
factory_attribute_types = [{'start_time':{'gsystem_names_list':['QuizItem','Forum','Task'],
                           ...
                           {'readinglevel':{'gsystem_names_list':['Quiz','Topic','File','Page','Pandora_video', 'E-Book','Jsmol','Asset'],
                                            'data_type':'basestring',
                                            'meta_type':'factory_types'}},
                           {'educationalsubject':{'gsystem_names_list':['Quiz','Topic','File','Page','Pandora_video', 'E-Book','Jsmol', 'base_unit','Asset', 'announced_unit', 'Module', 'Group'],
                                                  'data_type':'basestring',
                                                  'meta_type':'factory_types'}},
                           {'educationallevel':{'gsystem_names_list':['Quiz','Topic','File','Page','Pandora_video', 'E-Book','Jsmol', 'base_unit','Asset', 'announced_unit', 'Module', 'Author', 'Group'],
                                                'data_type':'list',
                                                'meta_type':'factory_types'}},
